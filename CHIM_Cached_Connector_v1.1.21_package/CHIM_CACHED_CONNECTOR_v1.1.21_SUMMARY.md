# CHIM Cached Connector v1.1.21 - Complete Fix for Thinking Toggle
...
2. **Extract Package**
   ```bash
   unzip CHIM_Cached_Connector_v1.1.21_package.zip
   cd CHIM_Cached_Connector_v1.1.21_package
   ```
...
```
CHIM_Cached_Connector_v1.1.21_package/
├── CHIM_CACHED_CONNECTOR_v1.1.21_SUMMARY.md (this file)
├── INSTALLATION_INSTRUCTIONS.txt
├── CHANGELOG.txt
├── ZIP_FILE_INFO.txt
├── connector/
│   ├── openrouterjsoncached.php (v1.1.21)
│   └── openrouterjsoncached_verbose.php (v1.1.21)
├── lib/
│   ├── core/
