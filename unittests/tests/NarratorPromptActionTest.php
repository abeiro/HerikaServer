...
{
    public function testNarratorInputTextExposesEnabledNarratorActionsInPromptAndSchema(): void
    {
        ...
        $this->assertStringContainsString('SpawnItem', $GLOBALS['responseTemplate']['action']);
        $this->assertStringContainsString('GiveGoldTo', $GLOBALS['responseTemplate']['action']);
        $this->assertStringContainsString('AVAILABLE ACTION: SpawnItem', $GLOBALS['PROMPT_ACTIONS_LIST']);
