...
INSERT INTO public.core_tts_connector VALUES (1, 'pockettts', 'ddistro pockettts', '{"_title": "PocketTTS (Installed in DwemerDistro)", "voiceid": {"type": "string", "helpurl": "/HerikaServer/ui/xtts_clone.php", "description": "Generated voice file name. Click the help link to go to voice management."}, "endpoint": {"type": "url", "helpurl": "https://dwemerdynamics.com/chim/tts.html#PocketTts", "description": "Endpoint URL. DwemerDistro audio.cpp PocketTTS uses port 8086 by default. Legacy Python PocketTTS uses port 8020."}, "api_format": {"type": "select", "values": ["audio_cpp", "legacy"], "description": "PocketTTS API format. Use audio_cpp for the DwemerDistro C++ runtime or legacy for the older Python bridge."}, "model": {"type": "string", "description": "audio.cpp model id. Default: pocket-tts."}, "language": {"type": "select", "values": ["ar", "pt", "zh-cn", "cs", "nl", "en", "fr", "de", "it", "pl", "ru", "es", "tr", "ja", "ko", "hu", "hi"], "description": "Language"}, "voicelogic": {"type": "select", "scope": "global", "values": ["voicetype", "name"], "description": "Default profile only. Logic used for generating [TTS POCKETTTS voiceid] <br> voicetype = NPC voicetype ID (femalenord) <br> name = NPC name (mjoll_the_lioness)"}}', NULL, 'http://127.0.0.1:8086', 'voiceid');
