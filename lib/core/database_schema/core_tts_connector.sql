...
INSERT INTO public.core_tts_connector VALUES (1, 'xtts-fastapi', 'ddistro xtts', '{"_title": "CHIM XTTS (Installed in DwemerDistro)", "voiceid": {"type": "string", "helpurl": "/HerikaServer/ui/xtts_clone.php", "description": "Generated voice file name. Click the help link to go to XTTS management."}, "endpoint": {"type": "url", "helpurl": "https://dwemerdynamics.hostwiki.io/en/TTS-Options#chim-xtts", "description": "Endpoint URL. Leave as default if you use CHIM XTTS.<br>You can run it on the cloud or use Mantella XTTS. Click the help link to learn more."}, "language": {"type": "select", "values": ["ar", "pt", "zh-cn", "cs", "nl", "en", "fr", "de", "it", "pl", "ru", "es", "tr", "ja", "ko", "hu", "hi"], "description": "Language"}, "voicelogic": {"type": "select", "scope": "global", "values": ["voicetype", "name"], "description": "Default profile only. Logic used for generating [TTS XTTSFASTAPI voiceid] <br> voicetype = NPC voicetype ID (femalenord) <br> name = NPC name (mjoll_the_lioness)"}}', NULL, 'http://127.0.0.1:8020', 'voiceid');
