...
$GLOBALS["npc_own_templates"]=[
    ...
    "female_breton_noble"=>[0x25844],
    "female_breton_merchant"=>[0x25844],
    "female_breton_warrior"=>[0x25845],
    "female_breton_assassin"=>[0x25846],
    "female_breton_mage"=>[0x25847],
    "female_breton_beggar"=>[0x25848],
    "female_breton_farmer"=>[0x25848],
    "female_breton_bard"=>[0x25849],
    "female_breton_soldier"=>[0x2584a],

    "male_nord_warrior"=>[0x2584d],

    "male_orc_warrior"=>[0x2584c],

    "male_argonian_assassin"=>[0x2584b],
