...
it enforces deterministic p95 below 25 ms on 500 representative extractions. Provider fallback time is
reported separately and is never part of that deterministic budget.
