...
class openrouterjsoncached_verbose
{
    ...
    const VERSION = 'OpenRouter Cache Connector v1.0.23 for CHIM 2.0.3 | 2025/11/11 (VERBOSE)';
        ...
        if ($this->_responseFormat === 'json') {
            ...
            if (!$this->_simpleFormatParsed) {
                ...
                if ($parsed['found']) {
                    ...
                    // VERBOSE_LOGGING_START - _parseAndReturnContent: Simple format parsing failed
                    if ($this->_verboseLogging) {
                        logMessage("[CACHE-VERBOSE] PARSING FAILURE - Complete buffer content:");
                        logMessage("[CACHE-VERBOSE] " . $this->_buffer);
                    }
                    // VERBOSE_LOGGING_END
