...
';
        ...
        if (isset($customParms["MAX_TOKENS"])) {
            if ($customParms["MAX_TOKENS"]==null) {
                ...
                $postData["n_predict"]=$customParms["MAX_TOKENS"]+0;
            }
        }
        ...
        if (isset($GLOBALS["FORCE_MAX_TOKENS"])) {
            if ($GLOBALS["FORCE_MAX_TOKENS"]==null) {
                ...
                $postData["n_predict"]=$GLOBALS["FORCE_MAX_TOKENS"]+0;
            }

        }

        
        $GLOBALS["DEBUG_DATA"]["llamacpp_prompt"]=$postData;
    ...
    public function process()
    {
        ...
        if (strpos($line, 'data: {"content": "{"}') !== false) {
         ...
         if (strpos($line, 'data: {"content": "]"}') === 0 || strpos($data["content"], ']')!==false) {
        ...
        if ((isset($this->_functionMode))&&($this->_functionMode)) {
            ...
            $this->_functionRawName.=$data["content"];
            return "";
        ...
        if (isset($data["content"])) {
            if (strlen(trim($data["content"],"\t\0\x0B"))>0) {
                $buffer.=$data["content"];
            }
            $totalBuffer.=$data["content"];
        }
