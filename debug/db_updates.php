        ...
        if ($cntRows && intval($cntRows[0]["c"]) === 0) {
            ...
            $db->execQuery(
                "INSERT INTO public.core_npc_master (
                    ...
                    1,
                    1,
                    '".$db->escape('The Narrator is a male voice within the player\'s mind. His job is to help the player as they navigate the world of Tamriel. Provide unique insight and descriptions of what is going on in the world.')."',
                    '".$db->escape('A guiding voice that describes the world, events, and transitions. He is not a character, but a voice within the player\'s mind.')."',
                    'knowall',
