...
$F_TRANSLATIONS["Inspect"]="Inspects a target character's OUTFIT and GEAR. JUST REPLY in a format similar to 'Let me see...' and then wait";
$F_TRANSLATIONS["LookAt"]="LOOK at or INSPECT an NPC, Actor, or being OUTFIT and GEAR";
$F_TRANSLATIONS["InspectSurroundings"]="Looks for entites, friendly or hostile, nearby";
$F_TRANSLATIONS["MoveTo"]= "Move to a visible building or visible actor, also used to guide {$GLOBALS["PLAYER_NAME"]} to a actor or building.";
...
$F_TRANSLATIONS["Attack"]="Attack with intetnion to kill an Actor, NPC or entity.";
$F_TRANSLATIONS["AttackHunt"]="Hunt with intetion to kill an Actor, NPC or entity.";
$F_TRANSLATIONS["Follow"]="Move to and follow a NPC, an actor or being";
$F_TRANSLATIONS["CheckInventory"]="Search in {$GLOBALS["HERIKA_NAME"]}'s inventory, backpack or pocket. List their inventory contents";
$F_TRANSLATIONS["SheatheWeapon"]="Sheates current weapon";
$F_TRANSLATIONS["Relax"]="Stop whatever you are doing and relax at the current location";
$F_TRANSLATIONS["LeadTheWayTo"]="Long distance travel command. Use it to move to major locations and landmarks.";
$F_TRANSLATIONS["TakeASeat"]="{$GLOBALS["HERIKA_NAME"]} take a seat at seating location nearby.";
...
$F_TRANSLATIONS["WaitHere"]="{$GLOBALS["HERIKA_NAME"]} waits and loiters at the current location";
...
$F_RETURNMESSAGES["IncreaseWalkSpeed"]="Increases {$GLOBALS["HERIKA_NAME"]} speed/pace when moving or travelling";
$F_RETURNMESSAGES["DecreaseWalkSpeed"]="Decreases {$GLOBALS["HERIKA_NAME"]} speed/pace when moving or travelling";
