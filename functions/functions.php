...
$F_TRANSLATIONS_LOCAL["Brawl"] = "#HERIKA_NAME# starts a Skyrim brawl with #PLAYER_NAME#: an agreed, bare-fisted fight that is not meant to kill. Fists only, no weapons, shields, spells, staves, or poisons. #PLAYER_NAME# is the only valid target. Use Attack instead when #HERIKA_NAME# truly means to kill.";
    ...
    [
        ...
        "parameters" => [
            ...
            "properties" => [
                "target" => [
                    "type" => "string",
                    "description" => "Always #PLAYER_NAME#. A brawl only works against the player, so no other name is accepted here.",
                ],
            ],
            "required" => ["target"],
        ],
