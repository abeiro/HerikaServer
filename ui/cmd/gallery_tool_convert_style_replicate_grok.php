...
if ($method === 'POST') {
    ...
    require_once dirname(__FILE__) . "/handlers/ReplicateGrokImagineHandler.class.php";
    ...
    $handler = new ReplicateGrokImagineHandler($api_key);
    ...
    $result = $handler->process([
        ...
        'aspect_ratio' => $jsonDataInput["aspect_ratio"] ?? "3:4",
        'quality'      => $jsonDataInput["quality"] ?? "medium",
        'resolution'   => $jsonDataInput["resolution"] ?? "2k",
    ]);
