...
foreach ($currentConf as $pname=>$parms) {
    ...
    if (!in_array($fieldName,["HERIKA_NAME","LOCK_PROFILE","HERIKA_PERS","HERIKA_DYNAMIC","HERIKA_BACKGROUND","HERIKA_PERSONALITY","HERIKA_APPEARANCE","HERIKA_RELATIONSHIPS","HERIKA_OCCUPATION","HERIKA_SKILLS","HERIKA_SPEECHSTYLE","HERIKA_GOALS","HERIKA_QUEST","DBDRIVER","TTS@AZURE@voice","TTS@MIMIC3@voice",'TTS@ELEVEN_LABS@voice_id',"TTS@openai@voice","TTS@CONVAI@voiceid","TTS@XTTSFASTAPI@voiceid","TTS@MELOTTS@voiceid", "OGHMA_KNOWLEDGE"]))
