...
foreach ($quickstartConf as $pname => $parms) {
    ...
    if ($parms["type"] == "string") {
        ...
        if ($pname == "TTSFUNCTION") {
            ...
            $parms["description"] = "Select either MeloTTS or XTTS. <br>You can install MeloTTS under Tools/Components/AMD or NVIDIA GPU in the DwemerDistro folder if you have not already.<br> You can install XTTS under Tools/Components/NVIDIA GPU in the DwemerDistro folder. <br><b>For xVASnyth you will need to edit the [TTS XVASNYTH url] in the Configuration Wizard to complete the setup after you are done with this menu!</b> <br><b>We recommend MeloTTS for most users.</b>";
        }
