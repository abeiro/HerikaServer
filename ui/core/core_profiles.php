...
<div class="llm-layout">
    ...
    <?php
        ...
        $profileToggleCards = [
            ...
            ['key' => 'MATERIALIZE_DIARY_ENABLED', 'icon' => '&#x1F4D5;', 'title' => 'Physical Diary', 'enabled' => $physicalDiaryEnabled, 'short' => 'Keep NPC diary entries in one readable inventory book.', 'help' => 'Automatically creates one physical diary in each NPC\'s inventory when they write a diary entry, then refreshes that same book after future entries.'],
