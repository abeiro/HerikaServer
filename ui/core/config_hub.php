...
<main class="d-flex flex-column">
    ...
    <div class="top-area">
        ...
        <div class="tab-buttons">
            ...
            <button class="tab-button" data-tab="items">🗡️Item Descriptions</button>
    ...
    <div class="content-area flex-grow-1 d-flex overflow-hidden" style="min-height: 0;">
        ...
        <div id="items" class="tab-content">
            <div class="embed-wrap">
                <iframe class="embed" loading="lazy" src="about:blank" data-src="<?php echo $webRoot; ?>/ui/item_upload.php?embed=1"></iframe>
            </div>
        </div>
