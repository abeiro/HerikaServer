...
<style>
    ...
    @media (max-width: 480px) { .page-header h2 { font-size: 1.4em; } }
</style>
<?php
...
<head>
    ...
    <meta charset="utf-8">
    <title>Chat Simulation (Needs reworking)</title>
    <script>
...
<body>
    <main class="container">
        <div class="page-header">
            ...
            <p style="margin-top:8px;">This chat is missing most of the context and expression of a conversation in skyrim. Do not use this as an indication of quality.</p>
        </div>
