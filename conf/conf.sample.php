...
$SCRIPTED_DIALOGUE_CONTEXT_MODE="scene"; //Scripted dialogue prompt context: scene, speaker, or disabled. Scene preserves current behavior.
$SCRIPTED_DIALOGUE_DEDUP_SECONDS=0; //Suppress repeated scripted dialogue lines within this many seconds. 0 disables suppression.
$SCRIPTED_DIALOGUE_CONTEXT_LIMIT=0; //Maximum recent scripted dialogue lines included per prompt. 0 keeps all matching lines.
